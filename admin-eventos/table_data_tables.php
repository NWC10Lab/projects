...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.6.2.1/table_data_tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Dec 2016 13:59:13 GMT -->
<head>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
					<?php foreach($usuarios as $usuario){ echo '
                    <tr class="gradeX">
                        <td> '.$usuario["email"].'</td>
						...
						<td class="right"><a href="" class="btn btn-success btn-xs"><i class="fa fa-envelope"></i> </a> <a class="btn btn-danger btn-xs" href=""> <i class="fa fa-trash"></i></a></td>
                    </tr>
                    '; } ?>
                    </tbody>
                    <tfoot>
