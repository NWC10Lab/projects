			...
			<ul class="nav nav-list">
				...
				<li class="active open">
					...
					<ul class="submenu">
						...
						<li class="">
							<a href="">
								<i class="menu-icon fa fa-caret-right"></i> Futuras
							</a>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Tablas de Datos</h3>

									<div class="clearfix">
										<div style="margin-bottom:10px">
											<a class="btn" href="<?=$_SERVER['PHP_SELF']?>">Ver Todos</a>
											<a class="btn" href="<?=$_SERVER['PHP_SELF']?>?asistencia=1">Ver Lista Asistentes</a>
										</div>
										<div class="">
											...
											<div id="formulario" class="oculto " style="<?=$styleBlock?>">
												<form method="post" action="<?=$_SERVER['PHP_SELF']?><?= $exten ?>">
													<?php if($mensajeUnico){ ?>
													<div>Mensaje para:</div>
													<div>Nombre:
														<?=$nombre?> Correo:
															<?=$email?>
													</div>
													<input type="text" name="nombre" value="<?=$nombre?>" required class="oculto">
													<input type="text" name="email" value="<?=$email?>" required class="oculto">
													<?php } ?>
													<input type="text" name="autor" placeholder="Autor del mensaje" required>
													<input type="text" name="correo" placeholder="Correo emisor del mensaje non-reply@huawai.com" required>
													<input type="text" name="asunto" placeholder="Asunto" required>
													<textarea name="mensaje" class="myTextarea" placeholder="Mensaje"></textarea>
													<input type="submit" name="formEmail" value="ENVIAR" class="btnEnviar">
												</form>
											</div>
											<div>
												<?=$mng?>
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="green" href="index.php?em=1&nombre=<?=$usuarios[$i][" nombre "]?>&email=<?=$usuarios[$i]["email "]?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a class="red" href="index.php?del=<?=$usuarios[$i][" id "]?>">
			...
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120">
                                                    <span class="blue bolder"><a id="nwc" href="http://nwc10.com/" target="_blanck">NWC10</a></span>
					<span>Transformacion Digital</span> &copy; 2016
					</span>
